...
class RemoteAPI {
  ...
  /**
   * view product follow parameter ID
   * @param  [type] $id id of product
   * 
   * @return [type] info of product
   */
  ...
  /**
   * put_product Update product
   * @param  [type] $id         id of product
   * @param  [type] $csrf_token CSRF token 
   * @param  [type] $data       data of product when user update info
   * 
   * @return [type]             return new info data product update and save
   */
   ...
   * @param  [type] $csrf_token     CSRF token
   * @param  [type] $id             id of product
   * @param  [type] $cookie_session cookie of user when logged in
   * @param  [type] $data   
   *         
   * @return [type]                 [description]
   */
  public function delete_product($csrf_token, $id, $cookie_session, $data) {
    $request_url = $this->gateway . $this->apiVersion . '/product/'. $id . '.json';
    $data_delete = http_build_query($data);
